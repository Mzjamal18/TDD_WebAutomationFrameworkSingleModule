...
import configuration.utilities.ReadPropertiesFromMahmudVai;
...
public class WebTestBaseSetupFromMahmudVai {
    // Create Driver
    public static WebDriver driver;

    // Read Properties
    static Properties readProperty = ReadPropertiesFromMahmudVai.loadProperties("src/main/resources/Config.properties");
